...
namespace Engine
{
    public class Monster : LivingCreature, IReward
    {
        ...
        public Monster() { }
        public Monster(int iD, string name, int maxHitPoints, int currentHitPoints , int rewardExperiencePoints, int rewardGold, int maxDamage) : base(iD, name, currentHitPoints, maxHitPoints)
        {
